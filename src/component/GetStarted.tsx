        ...
        <section className="p-12 mb-56">
            <div className="max-w-screen-xl mx-auto px-4 md:text-center md:px-8">
                ...
                <div className="mt-3 flex justify-center">
                    <NavLink to={(isLoggedIn.isloggedIn) ? "/solvequestion" : "/login"} className="flex justify-center w-36 py-2 px-3 text-white text-lg bg-indigo-600 duration-150 hover:bg-blue-950 active:bg-gray-900 rounded-lg shadow-md hover:shadow-none">
