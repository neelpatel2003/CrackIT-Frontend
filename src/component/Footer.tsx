            ...
            <div className="max-w-screen-xl mx-auto px-8 md:px-8 text-left p-0">
                <div className="justify-between items-center md:flex">
                    <div className="max-w-lg">
                        <h3 className="text-white text-[23px]">
                ...
                <div className="mt-6 py-4 border-t border-gray-700 items-center justify-between sm:flex">
                    <p className="text-gray-300">© 2024 CrackIT Inc. All rights reserved.</p>
                    <div className="flex items-center gap-x-6 text-gray-400 mt-1">
                        ...
                        <a href="https://github.com/neelpatel2003/CrackIt-Frontend">
